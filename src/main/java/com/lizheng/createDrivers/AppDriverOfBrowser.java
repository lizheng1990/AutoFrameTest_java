 ...
 * APP自带浏览器
 */
public class AppDriverOfBrowser {
    //成员变量driver
     ...
     * 构造方法，完成driver的实例化
     */
    public AppDriverOfBrowser(String device,String version,String appiumPort){
        //填写capabilities
        ...
        try {
            ...
            e.printStackTrace();
            AutoLogger.log.error("app自带浏览器启动失败，请检查appium日志信息！");
        }
