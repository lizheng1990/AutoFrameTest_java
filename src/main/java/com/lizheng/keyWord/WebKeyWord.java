...
//新建一个Robot类的对象
    ...
    public boolean assertByTitle(String expect){
        ...
        try {
            ...
            AutoLogger.log.info("断言标题中是否包含预期结果：" + expect + "成功！！！");
        } catch (Exception e) {
    ...
    public boolean assertByxpath(String xpath,String expect){
        ...
        try {
            ...
            AutoLogger.log.info("断言xpath\"" + xpath + "\"的值中是否包含预期结果：" + expect + "成功！！！");
        } catch (Exception e) {
    ...
    public boolean assertByPage(String expect) {
        ...
        try {
            ...
            AutoLogger.log.info("断言网页源码中是否包含" + expect + "成功！！！");
        } catch (Exception e) {
